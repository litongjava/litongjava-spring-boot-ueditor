var uri = projectName + '/userAgreement';
var title = "用户协议";
var active;
var cols = [
  [
    ...
    { field: 'name', width: 500, title: '协议名称' },
    { field: 'articleId', width: 150, title: "文章id" },
...
layui.use(['table', 'layer', 'form', 'laypage'], function() {
  ...
  table.on('tool(data-table)', function(obj) {
    ...
    switch (obj.event) {
      case 'edit':
        ...
        layerOpenForm(layer, title + "编辑页面", "userAgreementForm.html");
        break;
      case 'del':
      ...
      case 'preview':
        ...
        winHandler.location.href = './articlePreview.html?user_agreement_id=' + data.id;
        break;
    }
  });
  ...
  active = {
    add: function() {
      layerOpenForm(layer, title + "添加页面", "userAgreementForm.html");
    },
    batchdel: function() {
      //debugger;
...
//$('button.layui-btn-tool').on('click', function() {
//var type = $(this).data('type');
////console.log(type);
//active[type] ? active[type].call(this) : '';
//});